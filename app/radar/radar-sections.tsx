...
/**
 * The RADAR page's content sections (hero through the editorial note),
 * without the shared SiteNav/SiteFooter chrome. Used standalone on
 * /radar and embedded below the home page.
 */
export default function RadarSections({ lang }: { lang: RadarLang }) {
  ...
  return (
    <>
      <section className={styles.hero} id="radar-top">
